...
# Load your GeoJSON
gdf = gpd.read_file("statsnz-statistical-area-2-2023-generalised-SHP/statistical-area-2-2023-generalised.shp")
gdf = gdf.to_crs(epsg=4326)

# Save as GeoJSON
gdf.to_file("detailed_suburbs.geojson", driver="GeoJSON")
